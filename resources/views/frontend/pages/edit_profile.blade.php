...
<div class="features_items"><!--features_items-->
					...
					<div class="contact-form">
				    	...
				    	<form class="contact-form row" method="post" action="cap-nhat-thong-tin/{{$customer->id}}" enctype="multipart/form-data">
				    		@csrf
				            <div class="form-group col-md-12">
				            	<h5>Tên khách hàng</h5>
				                <input type="text" name="name" class="form-control" placeholder="Trống" value="{{$customer->customer_name}}">
				                 @if($errors->has('name'))
				            ...
				            <div class="form-group col-md-12">
				            	<h5>SĐT</h5>
				                <input type="text" name="phone" class="form-control" placeholder="Trống" value="{{$customer->customer_phone}}">
				                 @if($errors->has('phone'))
			                                <div class="alert alert-danger">
			                                    {{
			                                        $errors->first('phone')
				            ...
				            <div class="form-group col-md-12">
				                ...
				                <input type="text" name="address" class="form-control" placeholder="Trống"
				                @if($address!="")
				                 value="{{$address}}"
				                @endif>
				            ...
				            <div class="form-group col-md-12">
				            	<h5>Email</h5>
				                <input type="text" name="email" class="form-control" placeholder="Email" readonly value="{{$customer->customer_email}}">
				            </div>         
				            <div class="form-group  col-md-12">
			                    ...
			                    @if($customer->customer_avatar!="")
			                 	<img src="img/avatar/{{$customer->customer_avatar}}" width="100px" height="100px" alt=""/>    
			                 	@endif
			                 	<br/>
