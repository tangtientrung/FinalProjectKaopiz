						...
						<div class="bill-to">
							...
							<div class="form-one">
								<form action="/xac-nhan-dia-chi" method="post">
									@csrf
									<input type="text" name="name" placeholder="Tên *" value="{{$customer->customer_name}}">
									@if($errors->has('name'))
	                                <div class="alert alert-danger">
	                                    {{$errors->first('name')}}
	                                </div>
	                                @endif
									<input type="text" name="phone" placeholder="SĐT *" value="{{$customer->customer_phone}}">
									@if($errors->has('phone'))
	                                <div class="alert alert-danger">
	                                    {{$errors->first('phone')}}
	                                </div>
                                @endif
									...
									<select name="matp_available" >
										...
										<option value="{{$customer->tp->matp}}">{{$customer->tp->name_city}}</option>
										
									</select>
									<br/>
									<select name="maqh_available" >
										<option value="{{$customer->qh->maqh}}">{{$customer->qh->name_quanhuyen}}</option>
									</select>
									<br/>
									<select name="xaid_available" >
										<option value="{{$customer->xa->xaid}}">{{$customer->xa->name_xaphuong}}</option>
									</select>
